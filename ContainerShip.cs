...
namespace ContainerManagement
{
    public class ContainerShip
    {
        ...
        public double MaxWeightCapacity { get; } // in tons
        ...
        public ContainerShip(string name, double maxSpeed, int maxContainerCapacity, double maxWeightCapacity)
        {
            ...
            MaxWeightCapacity = maxWeightCapacity * 1000; // Convert tons to kg
        ...
        public void TransferContainer(ContainerShip targetShip, string containerSerial)
        {
            ...
            targetShip.LoadContainer(container); // Try loading onto the target ship
            Containers.Remove(container); // Remove from current ship
        ...
        {
            return new List<Container>(Containers); // Returns a copy of the list to prevent modification
        }
